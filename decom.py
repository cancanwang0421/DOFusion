...
class Encoder(nn.Module):
    def __init__(self):
        ...
        self.bn1 = nn.BatchNorm2d(8, eps=1e-5, momentum=0.1)
        self.conv2 = nn.Conv2d(8, 16, kernel_size=3, stride=1, padding=1)
        self.bn2 = nn.BatchNorm2d(16, eps=1e-5, momentum=0.1)
        self.conv3 = nn.Conv2d(16, 32, kernel_size=3, stride=1, padding=1)
        self.bn3 = nn.BatchNorm2d(32, eps=1e-5, momentum=0.1)
        self.conv4 = nn.Conv2d(32, 32, kernel_size=3, stride=1, padding=1)
        self.bn4 = nn.BatchNorm2d(32, eps=1e-5, momentum=0.1)
...
class CAM_VI_E(nn.Module):
    def __init__(self):
        ...
        self.conv1 = nn.Conv2d(32, 4, kernel_size=3, stride=1, padding=1)
        self.bn1 = nn.BatchNorm2d(4, eps=1e-5, momentum=0.1)
        self.conv2 = nn.Conv2d(4, 32, kernel_size=3, stride=1, padding=1)
...
class Decoder_VI_L(nn.Module):
    def __init__(self):
        ...
        self.l_conv1 = nn.Conv2d(32, 16, kernel_size=3, stride=1, padding=1)
        self.l_bn1 = nn.BatchNorm2d(16, eps=1e-5, momentum=0.1)
        self.l_conv2 = nn.Conv2d(32, 8, kernel_size=3, stride=1, padding=1)
        self.l_bn2 = nn.BatchNorm2d(8, eps=1e-5, momentum=0.1)
        self.l_conv3 = nn.Conv2d(8, 4, kernel_size=3, stride=1, padding=1)
        self.l_bn3 = nn.BatchNorm2d(4, eps=1e-5, momentum=0.1)
        self.l_conv4 = nn.Conv2d(8, 1, kernel_size=3, stride=1, padding=1)
